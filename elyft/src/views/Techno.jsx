...
export function Techno () {
    ...
    return (
        ...
        <>
            ...
            <Header pageTitle="Des logiciels sur mesure pour les entreprises" srcImg={pexelsLukas} headerDescription="Notre équipe s'appuie sur des frameworks open source robustes et intégrations
